        ...
        <div class="mt-4 row">
            ...
            <div class="col-sm-10">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <i class="fas fa-info-circle"></i>平日10時から19時（土日祝日は対応しておりません）
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-10">
                ...
                <form action="complete.php" method="post">
                    <div class="row form-group">
                        <label class="col-form-label col-sm-2">会社名：</label>
                        <div class="col-sm-10">
                    ...
                    <div class="row form-group">
                        <label class="col-form-label col-sm-2">メール：</label>
                        <div class="col-sm-10">
                    ...
                    <div class="row form-group">
                        <label class="col-form-label col-sm-2">内容：</label>
                        <div class="col-sm-10">
